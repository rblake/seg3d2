...
def find_matlab_process():
  ...
  #matlab_path='/usr/sci/OSX/matlab_r2012a/MATLAB_R2012a.app/bin/matlab'
  matlab_path=''
...
class MatlabPipe(object):
  ...
  def eval(self,
    ...
    if print_expression:
      print(expression)
    self.process.stdin.write(expression.encode())
...
"""
  def _sync_output(self, on_new_output=sys.stdout.write):
    ...
    output_string = 'disp(\'%s\');\n' % self.command_end_string
    #print("output_string=[", output_string, "]")
    self.process.stdin.write(output_string.encode())
...
if __name__ == '__main__':
  ...
  class TestMatlabPipe(unittest.TestCase):
    def setUp(self):
      ...
      self.matlab.open(print_matlab_welcome=True, working_directory='/Users/ayla/scratch/seg3d2/bin.debug_qt_4.8')
    
    def tearDown(self):
      self.matlab.close()

    def test_eval2(self):
      ret = self.matlab.eval('A = test2')
