# MODIFIED VERSION THAT LOOKS SPECIFICALLY IN THE QT_DIR DIRECTORY
...
IF (QT_DIR)
  ...
  IF (QT_DIR_CACHE)
    IF(NOT QT_DIR STREQUAL ${QT_DIR_CACHE})
      UNSET( QT_FOUND )
      UNSET( QT4_FOUND )
      UNSET( QT_QTCORE_FOUND )
      UNSET( QT_QTGUI_FOUND )
      UNSET( QT_QT3SUPPORT_FOUND )
      UNSET( QT_QTASSISTANT_FOUND )
      UNSET( QT_QTDESIGNER_FOUND )
      UNSET( QT_QTMOTIF_FOUND )
      UNSET( QT_QTNETWORK_FOUND )
      UNSET( QT_QTNSPLUGIN_FOUND )
      UNSET( QT_QTOPENGL_FOUND )
      UNSET( QT_QTSQL_FOUND )
      UNSET( QT_QTXML_FOUND )
      UNSET( QT_QTSVG_FOUND )
      UNSET( QT_QTTEST_FOUND )
      UNSET( QT_QTUITOOLS_FOUND )
      UNSET( QT_DEFINITIONS )
      UNSET( QT_INCLUDES )
      UNSET( QT_INCLUDE_DIR )
      UNSET( QT_QTCORE_INCLUDE_DIR )
      UNSET( QT_QT_INCLUDE_DIR )
      UNSET( QT_QT3SUPPORT_INCLUDE_DIR )
      UNSET( QT_QTASSISTANT_INCLUDE_DIR )
      UNSET( QT_QTCORE_INCLUDE_DIR )
      UNSET( QT_QTDESIGNER_INCLUDE_DIR )
      UNSET( QT_QTGUI_INCLUDE_DIR )
      UNSET( QT_QTMOTIF_INCLUDE_DIR )
      UNSET( QT_QTNETWORK_INCLUDE_DIR )
      UNSET( QT_QTNSPLUGIN_INCLUDE_DIR )
      UNSET( QT_QTOPENGL_INCLUDE_DIR )
      UNSET( QT_QTSQL_INCLUDE_DIR )
      UNSET( QT_QTXML_INCLUDE_DIR )
      UNSET( QT_QTSVG_INCLUDE_DIR )
      UNSET( QT_QTTEST_INCLUDE_DIR )
      UNSET( QT_LIBRARY_DIR )
      UNSET( QT_PLUGINS_DIR )
      UNSET( QT_QT3SUPPORT_LIBRARY )
      UNSET( QT_QT3SUPPORT_LIBRARY_RELEASE )
      UNSET( QT_QT3SUPPORT_DEBUG )
      UNSET( QT_QTASSISTANT_LIBRARY )
      UNSET( QT_QTASSISTANT_LIBRARY_RELEASE )
      UNSET( QT_QTASSISTANT_LIBRARY_DEBUG )
      UNSET( QT_QTCORE_LIBRARY )
      UNSET( QT_QTCORE_LIBRARY_RELEASE )
      UNSET( QT_QTCORE_LIBRARY_DEBUG )
      UNSET( QT_QTDESIGNER_LIBRARY )
      UNSET( QT_QTDESIGNER_LIBRARY_RELEASE )
      UNSET( QT_QTDESIGNER_LIBRARY_DEBUG )
      UNSET( QT_QTGUI_LIBRARY )
      UNSET( QT_QTGUI_LIBRARY_RELEASE )
      UNSET( QT_QTGUI_LIBRARY_DEBUG )
      UNSET( QT_QTMOTIF_LIBRARY )
      UNSET( QT_QTMOTIF_LIBRARY_RELEASE )
      UNSET( QT_QTMOTIF_LIBRARY_DEBUG )
      UNSET( QT_QTNETWORK_LIBRARY )
      UNSET( QT_QTNETWORK_LIBRARY_RELEASE )
      UNSET( QT_QTNETWORK_LIBRARY_DEBUG )
      UNSET( QT_QTNSPLUGIN_LIBRARY )
      UNSET( QT_QTNSPLUGIN_LIBRARY_RELEASE )
      UNSET( QT_QTNSPLUGIN_LIBRARY_DEBUG )
      UNSET( QT_QTOPENGL_LIBRARY )
      UNSET( QT_QTOPENGL_LIBRARY_RELEASE )
      UNSET( QT_QTOPENGL_LIBRARY_DEBUG )
      UNSET( QT_QTSQL_LIBRARY )
      UNSET( QT_QTSQL_LIBRARY_RELEASE )
      UNSET( QT_QTSQL_LIBRARY_DEBUG )
      UNSET( QT_QTXML_LIBRARY )
      UNSET( QT_QTXML_LIBRARY_RELEASE )
      UNSET( QT_QTXML_LIBRARY_DEBUG )
      UNSET( QT_QTSVG_LIBRARY )
      UNSET( QT_QTSVG_LIBRARY_RELEASE )
      UNSET( QT_QTSVG_LIBRARY_DEBUG )
      UNSET( QT_QTTEST_LIBRARY )
      UNSET( QT_QTTEST_LIBRARY_RELEASE )
      UNSET( QT_QTTEST_LIBRARY_DEBUG )
      UNSET( QT_QTMAIN_LIBRARY )
      UNSET( QT_QTMAIN_LIBRARY_RELEASE )
      UNSET( QT_QTMAIN_LIBRARY_DEBUG )
      UNSET( QT_QTUITOOLS_LIBRARY )
      UNSET( QT_QTUITOOLS_LIBRARY_RELEASE )
      UNSET( QT_QTUITOOLS_LIBRARY_DEBUG )
      UNSET( QT_MOC_EXECUTABLE )
      UNSET( QT_UIC_EXECUTABLE )
      UNSET( QT_UIC3_EXECUTABLE )
      UNSET( QT_RCC_EXECUTABLE )
      UNSET( QT_DOC_DIR )
      UNSET( QT_MKSPECS_DIR )
      UNSET( QT_WRAP_CPP )
      UNSET( QT_WRAP_UI )
      UNSET( QT_MOC_EXECUTABLE )
      UNSET( QT_UIC_EXECUTABLE )
      ...
      UNSET( QT4_QMAKE_FOUND )
      UNSET( QTVERSION )
                    
    ENDIF(NOT QT_DIR STREQUAL ${QT_DIR_CACHE})
  ENDIF (QT_DIR_CACHE)

  SET(QT_DIR_CACHE ${QT_DIR} "" CACHE INTERNAL "backup of QT_DIR" FORCE)
ENDIF (QT_DIR)
...
IF (QT4_QMAKE_FOUND)
  ...
  IF (NOT QT_BINARY_DIR)
     ...
     SET(QT_BINARY_DIR ${qt_bins} CACHE PATH "")
  ...
  IF (NOT QT_HEADERS_DIR)
      ...
      SET(QT_HEADERS_DIR ${qt_headers} CACHE PATH "")
