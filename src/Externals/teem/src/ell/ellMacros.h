...
#define ELL_2V_ADD3(v4, v1, v2, v3)       \
  ((v4)[0] = (v1)[0] + (v2)[0] + (v3)[0], \
   (v4)[1] = (v1)[1] + (v2)[1] + (v3)[1])

#define ELL_2V_ADD4(v5, v1, v2, v3, v4)       \
  ((v5)[0] = (v1)[0] + (v2)[0] + (v3)[0] + (v4)[0], \
   (v5)[1] = (v1)[1] + (v2)[1] + (v3)[1] + (v4)[1])

#define ELL_2V_SUB(v3, v1, v2)  \
  ((v3)[0] = (v1)[0] - (v2)[0], \
   (v3)[1] = (v1)[1] - (v2)[1])
...
#define ELL_3V_SCALE_ADD2_TT(v2, TT, s0, v0, s1, v1) \
  ((v2)[0] = AIR_CAST(TT, (s0)*(v0)[0] + (s1)*(v1)[0]),     \
   (v2)[1] = AIR_CAST(TT, (s0)*(v0)[1] + (s1)*(v1)[1]),     \
   (v2)[2] = AIR_CAST(TT, (s0)*(v0)[2] + (s1)*(v1)[2]))
...
#define ELL_3V_SCALE_ADD3_TT(v3, TT, s0, v0, s1, v1, s2, v2)     \
  ((v3)[0] = AIR_CAST(TT, (s0)*(v0)[0] + (s1)*(v1)[0] + (s2)*(v2)[0]),  \
   (v3)[1] = AIR_CAST(TT, (s0)*(v0)[1] + (s1)*(v1)[1] + (s2)*(v2)[1]),  \
   (v3)[2] = AIR_CAST(TT, (s0)*(v0)[2] + (s1)*(v1)[2] + (s2)*(v2)[2]))
...
#define ELL_3M_LERP(m3, w, m1, m2)           \
  (ELL_3V_LERP((m3)+0, (w), (m1)+0, (m2)+0), \
   ELL_3V_LERP((m3)+3, (w), (m1)+3, (m2)+3), \
   ELL_3V_LERP((m3)+6, (w), (m1)+6, (m2)+6))
...
#define ELL_3MV_CONTR(m, v) \
  ((m)[0]*(v)[0]*(v)[0] + (m)[1]*(v)[1]*(v)[0] + (m)[2]*(v)[2]*(v)[0] + \
